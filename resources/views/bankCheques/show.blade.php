            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    <div class="box box-bordered box-color">
                        <div class="box-title">
                            <h3><i class="icon-th-list"></i> {{$title}}: {{$bankCheque->student->name}}</h3>
                        </div>
                            ...
                            <div class="tab-content padding tab-content-inline tab-content-bottom">
                                ...
                                <div class="tab-pane" id="negociacao">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{route('bankCheques.destroy', ['bankCheque' => $bankCheque->id])}}" method="POST" onSubmit="return confirm('Deseja excluir?');" style="padding: 0px;margin:0px;">
                                                            ...
                                                            <a href="{{route('bankCheques.edit', ['bankCheque' => $bankCheque->id])}}" class="btn" rel="tooltip" title="" data-original-title="Editar">
                                                                <i class="icon-edit"></i>
                                                            </a>
                                        ...
                                        <form action="{{route('bankChequeTradings.store')}}" method="POST" class='form-vertical'>
                                            ...
                                            @foreach ($bankCheque->bankChequeTradings as $value)
                                            <div class="row-fluid">
                                                <div class="span1">
                                                    <div class="control-group">
                                                        <!--<label for="parcela" class="control-label">Parcela</label>-->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls controls-row">
                                                    <select name="negociado" id="negociado" class='select2-me input-block-level' required>
                                                        <option value="true" {{$bankCheque->negociado ? 'selected':''}}>SIM</option>
                                                        <option value="false" {{!$bankCheque->negociado ? 'selected':''}}>NÃO</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls controls-row">
                                                    <select name="boleto" id="boleto" class='select2-me input-block-level' required>
                                                        <option value="true" {{$bankCheque->boleto ? 'selected':''}}>SIM</option>
                                                        <option value="false" {{!$bankCheque->boleto ? 'selected':''}}>NÃO</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
@include('students.cep')
                    ...
                    <div class="box box-bordered box-color">
                        ...
                        <div class="box-content nopadding">
                            ...
                            <table id="history-table" class="table table-hover table-nomargin table-colored-header">
                                ...
                                <tbody>
                                @foreach ($bankCheque->bankChequeHistories as $value)
                                <tr>
                                    <td>
                                    ...
                                    @if($value->schedule == 'open')
                                        <form action="{{route('history.update')}}" method="POST" onSubmit="return confirm('Deseja encerrar?');" style="padding: 0px;margin:0px;">
                                            ...
                                            <input type="hidden" name="modulo" value="cheque">
            ...
            function saveHistory()
            {
                ...
                $.ajax({
                    url: "{{route('bankChequeHistories.store')}}",
                    type: "POST",
                    data: {
                        "_token": "{{csrf_token()}}",
                        "observacao": value,
